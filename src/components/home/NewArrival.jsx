...
class NewArrival extends Component {
    ...
    previous(){
     ...
     render() {
         ...
         <a className="btn btn-sm  ml-2  site-btn" onClick={this.next} ><i className="fa fa-angle-left"></i></a>
        &nbsp; <a className="btn btn-sm  ml-2  site-btn" onClick={this.previous} ><i className="fa fa-angle-right"></i></a>
